...
export default function TobPlan() {
  ...
  return (
    <>
      ...
      {/* モバイル版 */}
      <section className="w-full md:hidden bg-gray-50" style={{ paddingTop: '60px', paddingBottom: '60px', paddingLeft: '16px', paddingRight: '16px' }}>
        <div className="flex flex-col items-center gap-10">
          ...
          <div className="flex justify-center w-full">
            <div className="relative flex items-center" style={{ width: '198px', height: '52px', background: '#5C17FF', borderRadius: '300px', padding: '8px', gap: '10px' }}>
              <div
                className="toggle-slider absolute bg-white rounded-full shadow-md z-0"
                style={{ transform: isYearly ? 'translateX(90px)' : 'translateX(0)', width: '90px', height: '36px', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', left: '8px' }}
              />
              <button
                onClick={() => handleToggle(false)}
                className="relative z-10 text-sm font-bold transition-colors duration-300 flex items-center justify-center"
                style={{ color: isYearly ? '#FFFFFF' : '#5C17FF', width: '90px', height: '36px', borderRadius: '300px' }}
              >
                月単位
              </button>
              <button
                ...
                className="relative z-10 text-sm font-bold transition-colors duration-300 flex items-center justify-center"
                style={{ color: isYearly ? '#5C17FF' : '#FFFFFF', width: '90px', height: '36px', borderRadius: '300px' }}
              >
                年単位
              </button>
              <div className="absolute -top-3 right-[-48px] bg-[#F6FF51] text-[#6017FF] text-[10px] font-bold shadow-md animate-bounce" style={{ width: '82px', height: '22px', paddingTop: '4px', paddingRight: '10px', paddingBottom: '4px', paddingLeft: '10px', borderRadius: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                20%お得！
              </div>
            </div>
          </div>
      ...
      {/* PC版 */}
      <section className="hidden md:flex w-full bg-gray-50 justify-center" style={{ paddingTop: '60px', paddingBottom: '80px' }}>
